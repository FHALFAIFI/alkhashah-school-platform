...
## المساعد الذكي
- التفعيل/التعطيل والمزود والنموذج وفحص الاتصال: `/admin/settings/ai` (صلاحية `ai.manage`).
- المفاتيح في `.env` فقط: `ANYTHINGLLM_API_KEY`، `ANTHROPIC_API_KEY` — لا تدخل Git ولا قاعدة البيانات.
