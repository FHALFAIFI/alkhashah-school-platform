...
const MATRIX: Record<string, { category: CategoryKey } | { na: string }> = {
  ...
  "/assistant": { na: "مساعد ذكي — محادثات مؤقتة لا سجل مؤسسي" },
  "/assistant/drafts": { na: "مسودات المساعد — مؤقتة حتى تُعتمد في سجلها الأصلي" },

  // ── إعدادات وإدارة ───────────────────────────────────────────────────────
  "/admin/settings": { na: "إعدادات التطبيق — تهيئة لا بيانات مدرسية" },
  "/admin/settings/ai": { na: "إعدادات المساعد الذكي — تهيئة" },
