...
export const REPORTS: readonly ReportDefinition[] = [
  ...
  },
  {
    ...
    permission: "budget.read",
    columns: [col("amount", "المبلغ", "money"), col("expenseDate", "التاريخ", "date"), col("itemName", "البند"), col("paymentReference", "رقم الفاتورة"), col("supplier", "المورّد"), col("hasInvoice", "فاتورة مرفقة"), col("remainingBefore", "متبقي البند قبل العملية", "money"), col("remainingAfter", "متبقي البند بعد العملية", "money")],
