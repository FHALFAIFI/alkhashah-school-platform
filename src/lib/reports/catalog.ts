...
export const REPORTS: readonly ReportDefinition[] = [
  ...
  },
  {
    ...
    category: "finance",
    label: "سجل المصروفات",
    description: "كل المصروفات مع مبلغها وبندها ورقم فاتورتها ومورّدها والمتبقي من مخصص البند بعد كل عملية",
    permission: "budget.read",
    columns: [col("amount", "المبلغ", "money"), col("expenseDate", "التاريخ", "date"), col("itemName", "البند"), col("paymentReference", "رقم الفاتورة"), col("supplier", "المورّد"), col("hasInvoice", "فاتورة مرفقة"), col("remainingAfter", "متبقي البند بعد العملية", "money")],
  ...
  },
  {
    ...
    description: "الإيرادات والمصروفات في سجل واحد مرتّب زمنياً مع المتبقي من مخصص البند بعد كل مصروف",
    permission: "budget.read",
    columns: [col("kind", "النوع"), col("amount", "المبلغ", "money"), col("date", "التاريخ", "date"), col("itemName", "البند"), col("description", "البيان"), col("hasInvoice", "فاتورة"), col("remainingAfter", "متبقي البند بعد العملية", "money")],
    filters: ["search", "dateRange", "item"],
  },
  {
    key: "monthly-trend",
  ...
  },
  {
    ...
    columns: [
      ...
      col("role", "الدور"),
      col("position", "العمل في اللجنة"),
      col("membership", "العضوية"),
      col("tasks", "المهام المسندة"),
      col("taskStatuses", "حالة المهام"),
    ],
    filters: ["search", "person"],
  },
  {
