...
const GENERAL_SUGGESTIONS = [
  "ما البرامج المتأخرة هذا الشهر؟",
  "ما الشواهد الناقصة؟",
  "ما الغرف التي تحتاج إلى فحص؟",
  "اشرح أرقام لوحة المتابعة",
  "جهز مسودة التقرير التنفيذي الشهري",
];

const CONTEXT_SUGGESTIONS: Record<string, string[]> = {
  program: ["لخص حالة هذا البرنامج", "أنشئ مسودة تحديث لهذا البرنامج", "ما الشواهد الناقصة؟"],
  meeting: ["أنشئ مسودة جدول أعمال لهذا الاجتماع", "حوّل هذه الملاحظات إلى مسودة محضر", "أنشئ إجراءات من قرارات هذا الاجتماع"],
  committee: ["أنشئ مسودة جدول أعمال للجنة", "ما اجتماعات هذه اللجنة؟"],
  performance: ["لخص أداء هذا المعلم دون تغيير الدرجات", "أنشئ مسودة خطة تحسين", "ما الجلسات غير المكتملة؟"],
  room: ["أنشئ بلاغ صيانة لهذه الغرفة", "متى آخر فحص لهذه الغرفة؟", "أنشئ ملخص فحص"],
