...
const TASKS: { id: string; text: string; href: string }[] = [
  ...
  { id: "t11", text: "من صفحة برنامج اضغط «طباعة بطاقة البرنامج» وأصدر التقرير: فيه الرقم التسلسلي واعتماد المدير ودورة الحياة (الاكتمال الموثق منفصل عن الإقفال)", href: "/plan" },
