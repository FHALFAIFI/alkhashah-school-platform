...
export default async function ReportsPage() {
  ...
  const moduleReports: { title: string; desc: string; href: string; permission?: string; cta: string }[] = [
    { title: "الخطة التشغيلية", desc: "تقرير تفصيلي لكل برنامج: الأنشطة، المسؤولون، التقدم، الجاهزية، المخرجات، الشواهد، الميزانية، النواقص، سجل الاكتمال/التجاوز", href: "/plan", permission: "plan.read", cta: "من صفحة البرنامج" },
    ...
    { title: "الميزانية والمصروفات", desc: "الملخص المالي، المخطط مقابل الفعلي، المصروفات غير المرتبطة، الإيصالات الناقصة، التجاوزات", href: "/budget", permission: "budget.read", cta: "فتح الميزانية" },
  ...
  return (
    <div className="space-y-6">
      ...
      <section>
        ...
        <Card>
          <p className="text-sm text-gray-600">
            لكل برنامج تشغيلي تقرير واحد يجمع الأنشطة والمسؤولين والجدول الزمني والتقدم والجاهزية والمخرجات والشواهد
            والميزانية والمتطلبات الناقصة وسجل الاكتمال/التجاوز والنتائج والأثر. يُصدر من صفحة البرنامج بلقطة ثابتة
            قابلة لإعادة التوليد كنسخة جديدة.
          </p>
      ...
      <section>
        ...
        <Card>
          <p className="text-sm text-gray-600">
            تقرير موحّد عبر تقدم الخطة، البرامج المتأخرة، جاهزية الشواهد، دورات الأداء، التقارير الموقعة الناقصة،
