#!/usr/bin/env bash
# v2.5.0 §24 — build a disposable clone of production and run the RC on it.
#
...
NET=madrasa-rehearsal-v250-net
PG=madrasa-rehearsal-v250-pg
APP=madrasa-rehearsal-v250-app
VOL_DB=madrasa-rehearsal-v250-dbdata
VOL_UP=madrasa-rehearsal-v250-uploads
PORT=3087
RC_IMAGE=${RC_IMAGE:-madrasa-app:0.1.0-v2_5_0-rc}
WORK=$(mktemp -d)
...
Clone is up.  Run the rehearsal:
  ...
  REHEARSAL_PG=$PG \\
  node scripts/v250-clone-rehearsal.mjs
